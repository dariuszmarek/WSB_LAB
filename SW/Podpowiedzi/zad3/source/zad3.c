...
// ---------------------------------------------------
//to do 1 - skopiuj podaną w instrukcji tablicę kolorów oraz stwórz strukturę umożliwiającą przechowywanie countera oraz koloru, nazwij ją: point
...
int main(int argc, char **argv)
{
	...
	// to do 2 ---------------------------------------------------- 
	// Przydziel pamięć dla całego (mapowanego) ekranu gry, pamiętając o stworzonej strukturze point. 
	// Podczas inicjalizacji ustaw kolory początkowe oraz countery na 0. 
	...
	while (1)
	{
		...
		// drawQuad(i, j, 3, 3);
		// dla wszystkich wartości countera > 0, pamiętaj o aktualnym kolorze, a następnie zmniejsz wartość licznika o 1.
